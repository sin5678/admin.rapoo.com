<?php
    ...
    $sql = "select * from rap_producttranslate ";
    ...
    while($row = mysqli_fetch_assoc($result)) {
            ...
            foreach ($bgstyleArr as $styleItem) {
                ...
                if ($tArr[0] == "background") {
                    ...
                    $arr=explode("/",$backgroundArr[2]);
                     ...
                     $tempStr= str_replace(")","",$arr[2]);
                    $tempStr= str_replace("'","",$tempStr);
					 
				    $maidian['file'][] =$tempStr;
        ...
        $maidainJson= base64_encode(serialize($maidian));
          ...
          $sql = "update rap_producttranslate set ProductShowJSON =\"".$maidainJson."\" where TranslateID=".$row['TranslateID'];
