...
$(function(){
    ...
    $.ajax({
        ...
        url: "/article/index?start_date=2014-01-01&end_date=2014-12-31&page=1",
        dataType: "json",
            ...
            if(data != ''){
                ...
                //$.each(data, function(contentIndex, content){
                    html += '<h2>'+data['title']+'</h2>' +
                			'<div class="desc_box">' +
                			'<div class="newsshare">' +
                            	'<span class="description">'+data['time']+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' + data['jiathis'] +
                            '</div>' +
                            '</div>' +
                            data['contents'];
                //});
...
function getNewsMorePc(startTime, endTime, page, id){
    $.ajax({
        type: "GET",
        url: "/article/index?start_date="+startTime+"&end_date="+endTime+"&page="+page,
        dataType: "json",
        beforeSend: function(){
