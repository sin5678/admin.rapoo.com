...
(function (global, factory) {
  ...
  $.fn.fullpage = function (options) {
    ...
    options = $.extend({
      ...
      headerStatus: 0,
      footerStatus: 0,
      scrollingSpeed: ((navigator.appVersion.indexOf("Mac")!=-1)?1000:700),
      autoScrolling: true,
      fitToSection: true,
    ...
    FP.moveSectionUp = function(){
        ...
        var current = $('.fp-section.active');
        //looping to the bottom if there's no more sections above
        if (!prev.length && (options.loopTop || options.continuousVertical)) {
            prev = $(SECTION_SEL).last();
        }

      /*if ((current.index() == 0 && options.headerStatus == 0) || (!prev.length && options.headerStatus == 1)) {
//        $('#page-header,#wy_subnav_bg').css({
//          "margin-top": "0px","transition":".2s"
//        });
        $('#page-header,#wy_subnav_bg').css("margin-top","0px");
      
        options.headerStatus = 0;
      }*/


      if (options.footerStatus == 1) {
        $('#dowebok').css({
          "margin-top": "0px"
        });
        $('.web_app_bg2').css({
    ...
    FP.moveSectionDown = function () {
      ...
      if (!next.length && options.footerStatus == 0) {
        $('#dowebok').css({
          "margin-top": "-" + $("#pageFooter").outerHeight() + "px"
        });
        $('.web_app_bg2').css({
          "margin-bottom": $("#pageFooter").outerHeight() + "px"
        });
        options.footerStatus = 1;
      }


      //page header scroll top hide
      var currentIndex = next.index();
      /*if (currentIndex == 1 && options.headerStatus == 0) {
        $('#page-header,#wy_subnav_bg').css("margin-top","-50px");
        options.headerStatus = 1;
      } else {*/
        if (next.length) {
